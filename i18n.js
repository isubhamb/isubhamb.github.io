...
(function () {
  ...
  // ── Detect language for static hosting ───────────────────────────────
  // Works for: GitHub Pages, Netlify, Vercel, Cloudflare Pages etc.
  // Priority: (1) data-lang on <html> set by the page itself
  //           (2) URL path segment  /bn/  /hi/  /zh/  /ja/
  ...
  function detectLang() {
    ...
    // 2. URL path — handles /bn/, /bn/index.html, /bn, /hi/ etc.
    ...
    // 4. Browser language hint (best-effort)
  ...
  // Always persist so the toggle buttons stay consistent
