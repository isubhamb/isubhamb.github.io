...
(function ($) {
  ...
  // ── i18n translations for converter UI ───────────────────────────────────
  const CONV_TR = {
    en: {
      // Topbar button
      'btn.convert':        'Convert',
      // Modal header
      'modal.title':        'File Converters',
      'modal.close':        'Close',
      // Category sidebar
      'cat.all':            'All Converters',
      'cat.pdf-out':        'PDF → Other',
      'cat.pdf-util':       'PDF Utilities',
      'cat.to-pdf':         'Files → PDF',
      'cat.image':          'Image Convert',
      'cat.doc':            'Documents',
      // Work area
      'work.back':          'Back to converters',
      'work.subtitle':      'Drop files below to convert',
      'dz.title':           'Drop files here or click to browse',
      'dz.accepts':         'Accepts',
      'options.title':      'Options',
      'btn.convert-action': 'Convert',
      'btn.clear':          'Clear',
      'status.converting':  'Converting\u2026',
      'status.ready':       'file(s) ready',
      'status.error':       'Error',
      // File queue statuses
      'file.pending':       'Pending',
      'file.working':       '\u27F3 Converting\u2026',
      'file.done':          '\u2713 Done',
      'file.error':         '\u2717 Error',
      'file.remove':        'Remove',
      // Download
      ...
      // Privacy note
      'privacy':            'All conversions happen <strong>100% in your browser</strong> \u2014 files never leave your device.',
    },
    bn: {
      'btn.convert':        'রূপান্তর',
      'modal.title':        'ফাইল রূপান্তরকারী',
      'modal.close':        'বন্ধ করুন',
      'cat.all':            'সব রূপান্তরকারী',
      'cat.pdf-out':        'PDF → অন্যান্য',
      'cat.pdf-util':       'PDF টুলস',
      'cat.to-pdf':         'ফাইল → PDF',
      'cat.image':          'ছবি রূপান্তর',
      'cat.doc':            'ডকুমেন্ট',
      'work.back':          'রূপান্তরকারীতে ফিরুন',
      'work.subtitle':      'রূপান্তরের জন্য নিচে ফাইল ফেলুন',
      'dz.title':           'এখানে ফাইল ফেলুন বা ব্রাউজ করুন',
      'dz.accepts':         'গ্রহণযোগ্য',
      'options.title':      'বিকল্পসমূহ',
      'btn.convert-action': 'রূপান্তর করুন',
      'btn.clear':          'পরিষ্কার করুন',
      'status.converting':  'রূপান্তরিত হচ্ছে\u2026',
      'status.ready':       'ফাইল প্রস্তুত',
      'status.error':       'ত্রুটি',
      'file.pending':       'অপেক্ষমাণ',
      'file.working':       '\u27F3 রূপান্তরিত হচ্ছে\u2026',
      'file.done':          '\u2713 সম্পন্ন',
      'file.error':         '\u2717 ত্রুটি',
      'file.remove':        'সরান',
      'dl.download':        'ডাউনলোড',
      'privacy':            'সব রূপান্তর <strong>১০০% আপনার ব্রাউজারে</strong> হয় \u2014 ফাইল কখনো আপনার ডিভাইস ছাড়ে না।',
    },
    hi: {
      'btn.convert':        'कन्वर्ट',
      'modal.title':        'फ़ाइल कनवर्टर',
      'modal.close':        'बंद करें',
      'cat.all':            'सभी कनवर्टर',
      'cat.pdf-out':        'PDF → अन्य',
      'cat.pdf-util':       'PDF टूल्स',
      'cat.to-pdf':         'फ़ाइलें → PDF',
      'cat.image':          'छवि रूपांतरण',
      'cat.doc':            'दस्तावेज़',
      'work.back':          'कनवर्टर पर वापस',
      'work.subtitle':      'रूपांतरण के लिए नीचे फ़ाइलें छोड़ें',
      'dz.title':           'फ़ाइलें यहाँ छोड़ें या ब्राउज़ करें',
      'dz.accepts':         'स्वीकृत',
      'options.title':      'विकल्प',
      'btn.convert-action': 'कन्वर्ट करें',
      'btn.clear':          'साफ़ करें',
      'status.converting':  'परिवर्तित हो रहा है\u2026',
      'status.ready':       'फ़ाइलें तैयार',
      'status.error':       'त्रुटि',
      'file.pending':       'प्रतीक्षारत',
      'file.working':       '\u27F3 परिवर्तित हो रहा है\u2026',
      'file.done':          '\u2713 हो गया',
      'file.error':         '\u2717 त्रुटि',
      'file.remove':        'हटाएं',
      'dl.download':        'डाउनलोड',
      'privacy':            'सभी रूपांतरण <strong>100% आपके ब्राउज़र में</strong> होते हैं \u2014 फ़ाइलें आपके डिवाइस से कभी नहीं जाती।',
    },
    zh: {
      'btn.convert':        '转换',
      'modal.title':        '文件转换器',
      ...
      'cat.doc':            '文档',
      'work.back':          '返回转换器列表',
      'work.subtitle':      '将文件拖放到下方进行转换',
      'dz.title':           '将文件拖放到这里或点击浏览',
      'dz.accepts':         '支持格式',
      'options.title':      '选项',
      'btn.convert-action': '开始转换',
      'btn.clear':          '清除',
      ...
      'file.remove':        '移除',
      'dl.download':        '下载',
      'privacy':            '所有转换均在<strong>您的浏览器中完成</strong> \u2014 文件永远不会离开您的设备。',
    },
    ja: {
      'btn.convert':        '変換',
      'modal.title':        'ファイル変換',
      ...
      'cat.all':            'すべての変換',
      'cat.pdf-out':        'PDF → その他',
      'cat.pdf-util':       'PDF ツール',
      'cat.to-pdf':         'ファイル → PDF',
      'cat.image':          '画像変換',
      'cat.doc':            'ドキュメント',
      'work.back':          '変換リストに戻る',
      'work.subtitle':      '変換するファイルを下にドロップ',
      'dz.title':           'ここにファイルをドロップまたはブラウズ',
      'dz.accepts':         '対応形式',
      'options.title':      'オプション',
      'btn.convert-action': '変換する',
      'btn.clear':          'クリア',
      'status.converting':  '変換中\u2026',
      'status.ready':       '個のファイルが準備完了',
      'status.error':       'エラー',
      'file.pending':       '待機中',
      'file.working':       '\u27F3 変換中\u2026',
      'file.done':          '\u2713 完了',
      ...
      'file.remove':        '削除',
      'dl.download':        'ダウンロード',
      'privacy':            'すべての変換は<strong>ブラウザ内で完結</strong>します \u2014 ファイルがデバイスから送信されることはありません。',
    },
  };
  ...
  function convT(key) {
    return (CONV_TR[convLang] && CONV_TR[convLang][key]) || CONV_TR.en[key] || key;
  }

  // Apply converter translations to DOM (called by i18n.js hook)
  function applyConvTranslations(lang) {
    convLang = lang;

    // Topbar convert button
    const convBtn = document.getElementById('btn-converters');
    if (convBtn) convBtn.innerHTML = `<i class="bi bi-arrow-left-right"></i> ${convT('btn.convert')}`;

    // Modal title
    const modalTitle = document.querySelector('#converters-modal .conv-title');
    if (modalTitle) modalTitle.innerHTML = `<i class="bi bi-arrow-left-right"></i> ${convT('modal.title')}`;

    // Close button title
    const closeBtn = document.getElementById('conv-modal-close');
    if (closeBtn) closeBtn.title = convT('modal.close');
    ...
    document.querySelectorAll('.conv-cat-btn').forEach(btn => {
      ...
      const label = convT(key);
      if (label !== key) btn.innerHTML = iconHtml + label;
    });

    // Back button
    const backBtn = document.getElementById('conv-back-btn');
    if (backBtn) backBtn.innerHTML = `<i class="bi bi-chevron-left"></i> ${convT('work.back')}`;

    // Work subtitle (default state only — don't override active converter desc)
    const subTitle = document.getElementById('conv-work-subtitle');
    if (subTitle && (!activeConv)) subTitle.textContent = convT('work.subtitle');

    // Dropzone
    const dzTitle = document.querySelector('#conv-dropzone .cdz-title');
    if (dzTitle) dzTitle.textContent = convT('dz.title');

    // Options title
    const optsTitle = document.getElementById('conv-options-title');
    if (optsTitle) optsTitle.textContent = convT('options.title');

    // Convert action button
    const convertBtn = document.getElementById('conv-convert-btn');
    if (convertBtn) convertBtn.innerHTML = `<i class="bi bi-play-fill"></i> ${convT('btn.convert-action')}`;

    // Clear button
    const clearBtn = document.getElementById('conv-clear-btn');
    if (clearBtn) clearBtn.innerHTML = `<i class="bi bi-trash2"></i> ${convT('btn.clear')}`;

    // Privacy note
    const privacyNote = document.querySelector('.conv-privacy-note');
    if (privacyNote) privacyNote.innerHTML = `<i class="bi bi-shield-lock-fill"></i> ${convT('privacy')}`;

    // Section titles in grid (All Converters heading, etc.)
    document.querySelectorAll('.conv-section-title').forEach(el => {
      const section = el.closest('.conv-section');
      if (!section) return;
      ...
      const iconHtml = icon ? icon.outerHTML : '';
      const label = convT(key);
      if (label !== key) el.innerHTML = iconHtml + label;
    });

    // File statuses in queue
    document.querySelectorAll('.conv-fi-status').forEach(el => {
      const status = [...el.classList].find(c => ['pending','working','done','error'].includes(c));
      if (status) {
        const labels = {
          pending: convT('file.pending'),
          working: convT('file.working'),
          done:    convT('file.done'),
          error:   convT('file.error'),
        };
    ...
    // Download buttons
    document.querySelectorAll('.conv-dl-btn').forEach(btn => {
      const icon = btn.querySelector('i');
      const iconHtml = icon ? icon.outerHTML : '';
      btn.innerHTML = `${iconHtml} ${convT('dl.download')}`;
    });

    // Status message — translate if it's a known pattern
    const statusMsg = document.getElementById('conv-status-msg');
    if (statusMsg) {
      const txt = statusMsg.textContent;
      if (txt === 'Converting…' || txt.includes('Converting')) {
        statusMsg.textContent = convT('status.converting');
      } else if (txt.includes('ready')) {
        const num = txt.match(/\d+/);
        statusMsg.textContent = num ? `✓ ${num[0]} ${convT('status.ready')}` : txt;
      }
    }
  }

  // Register hook for i18n.js to call when language changes
  window.__convApplyLang = applyConvTranslations;
  ...
  function init() {
    injectHTML();
    bindEvents();
    // Hook into i18n.js language changes
    const _origApply = window.__convApplyLang;
    window.__convApplyLang = applyConvTranslations;
    // Apply current language if already set
    const savedLang = localStorage.getItem('yfd-lang');
    if (savedLang && savedLang !== 'en') {
      setTimeout(() => applyConvTranslations(savedLang), 200);
    }
  }
  ...
  function injectHTML() {
    ...
    CATEGORIES.forEach(c => {
      catHtml += `<button class="conv-cat-btn${c.id === 'all' ? ' active' : ''}" data-cat="${c.id}">
        <i class="bi ${c.icon}"></i>${CONV_TR[convLang]?.['cat.' + c.id] || c.label}
      </button>`;
    });
  ...
  <div id="converters-modal" role="dialog" aria-modal="true" aria-label="File Converters">
    ...
    <div class="conv-head">
      <div class="conv-title">
        <i class="bi bi-arrow-left-right"></i> ${CONV_TR[convLang]?.['modal.title'] || 'File Converters'}
      </div>
    ...
    <div class="conv-body">
      ...
      <div id="conv-panel">
        ...
        <div id="conv-work-area">
          <button id="conv-back-btn"><i class="bi bi-chevron-left"></i> ${CONV_TR[convLang]?.['work.back'] || 'Back to converters'}</button>

          <div id="conv-work-header">
            <div id="conv-work-icon"><i class="bi bi-arrow-left-right"></i></div>
            <div>
              <div id="conv-work-title">Converter</div>
              <div id="conv-work-subtitle">${CONV_TR[convLang]?.['work.subtitle'] || 'Drop files below to convert'}</div>
            </div>
          </div>
          ...
          <div id="conv-dropzone">
            ...
            <div class="cdz-title">${CONV_TR[convLang]?.['dz.title'] || 'Drop files here or click to browse'}</div>
          ...
          <div id="conv-options" style="display:none">
            <div id="conv-options-title">${CONV_TR[convLang]?.['options.title'] || 'Options'}</div>
          </div>

          <!-- Action row -->
          <div id="conv-action-row">
            <button id="conv-convert-btn" disabled>
              <i class="bi bi-play-fill"></i> ${CONV_TR[convLang]?.['btn.convert-action'] || 'Convert'}
            </button>
            <button id="conv-clear-btn"><i class="bi bi-trash2"></i> ${CONV_TR[convLang]?.['btn.clear'] || 'Clear'}</button>
          ...
          <div class="conv-privacy-note">
            ...
            ${CONV_TR[convLang]?.['privacy'] || 'All conversions happen <strong>100% in your browser</strong> — files never leave your device.'}
          </div>
        </div>
...
`;
    ...
    const btn = $(`<button id="btn-converters" title="${CONV_TR[convLang]?.['modal.title'] || 'File Converters'}">
      <i class="bi bi-arrow-left-right"></i> ${CONV_TR[convLang]?.['btn.convert'] || 'Convert'}
    </button>`);
    $('#btn-open').before(btn);
  }
  ...
  function buildAllGrids() {
    ...
    CATEGORIES.forEach(cat => {
      ...
      html += `<div class="conv-section${cat.id === 'all' ? ' active' : ''}" data-section="${cat.id}">
        <div class="conv-section-title"><i class="bi ${cat.icon}"></i>${CONV_TR[convLang]?.['cat.' + cat.id] || cat.label}</div>
        <div class="conv-grid">`;
      convs.forEach(c => {
  ...
  function openConverter(conv) {
    ...
    $('#conv-dz-hint').text(convT('dz.accepts') + ': ' + conv.accept.split(',').join(', '));
  ...
  function renderFileList() {
    ...
    queuedFiles.forEach((file, i) => {
      $list.append(`<div class="conv-file-item" id="conv-fi-${i}">
        ...
        <span class="conv-fi-status pending" id="conv-fi-status-${i}">${convT('file.pending')}</span>
        <button class="conv-fi-remove" data-idx="${i}" title="${convT('file.remove')}"><i class="bi bi-x"></i></button>
      </div>`);
    });
  }
  ...
  async function runConversion() {
    ...
    updateConvertBtn();
    $('#conv-download-row').removeClass('visible').empty();
    $('#conv-status-msg').text(convT('status.converting'));
    ...
    try {
      ...
      if (allResults.length) {
        ...
        $('#conv-status-msg').text(`✓ ${allResults.length} ${convT('status.ready')}`);
      }
    } catch (err) {
      $('#conv-status-msg').text(convT('status.error') + ': ' + err.message);
  ...
  function setFileStatus(idx, status, msg) {
    ...
    const labels = { pending: convT('file.pending'), working: convT('file.working'), done: convT('file.done'), error: convT('file.error') + (msg ? ': '+msg : '') };
    ...
    results.forEach(r => {
      ...
      $row.append(`<div class="conv-dl-item">
        ...
        <a href="${url}" download="${r.name}" class="conv-dl-btn">
          <i class="bi bi-download"></i> ${convT('dl.download')}
        </a>
      </div>`);
    });
